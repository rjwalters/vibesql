...
array set vibesql_skip_tests {
    ...
    index-14.4 "Index scan with mixed types produces incorrect results"
    index-14.5 "Index scan with mixed types produces incorrect results"
    index-14.6 "Index scan with mixed types produces incorrect results"
    index-14.7 "Index scan with mixed types produces incorrect results"
    index-14.8 "Index scan with mixed types produces incorrect results"
    index-14.9 "Index scan with mixed types produces incorrect results"
    index-14.10 "Index scan with mixed types produces incorrect results"
