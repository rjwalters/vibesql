...
array set vibesql_skip_tests {
    ...
    joinD-43 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-62 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-119 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-138 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-157 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-176 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-195 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-214 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-233 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-251 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-269 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-287 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-343 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-362 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-419 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-438 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-457 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-476 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-495 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-514 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-533 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-551 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-569 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-587 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-643 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-662 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-719 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-738 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-757 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-776 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-795 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-814 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-833 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-851 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-869 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-887 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-938 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-955 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1006 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1023 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1040 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1057 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1074 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1091 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1108 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1124 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1140 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
    joinD-1156 "ON-true join + later RIGHT/FULL JOIN mis-applies WHERE on inner tables; path-independent, separate from #5702 (issue #5709)"
