...
array set vibesql_skip_tests {
    ...
    selectB-2.4.transform "Optimizer enhancement tracked in issue #5723: outer WHERE predicate is not pushed into UNION ALL compound-view branches, so EXPLAIN VM opcode parity (test_transform) expects SeekGE but synthesizes Rewind for the subquery form. The .sql1/.sql2 result sub-tests pass; only the VDBE-opcode-parity .transform sub-test fails. Not a query-result correctness bug."
    selectB-2.5.transform "Optimizer enhancement tracked in issue #5723: outer WHERE predicate is not pushed into UNION ALL compound-view branches, so EXPLAIN VM opcode parity (test_transform) expects SeekGE but synthesizes Rewind for the subquery form. The .sql1/.sql2 result sub-tests pass; only the VDBE-opcode-parity .transform sub-test fails. Not a query-result correctness bug."
    selectB-2.6.transform "Optimizer enhancement tracked in issue #5723: outer WHERE predicate is not pushed into UNION ALL compound-view branches, so EXPLAIN VM opcode parity (test_transform) expects SeekGE but synthesizes Rewind for the subquery form. The .sql1/.sql2 result sub-tests pass; only the VDBE-opcode-parity .transform sub-test fails. Not a query-result correctness bug."
    selectB-2.11.transform "Optimizer enhancement tracked in issue #5723: outer WHERE predicate is not pushed into UNION ALL compound-view branches, so EXPLAIN VM opcode parity (test_transform) expects SeekGE but synthesizes Rewind for the subquery form. The .sql1/.sql2 result sub-tests pass; only the VDBE-opcode-parity .transform sub-test fails. Not a query-result correctness bug."
