...
array set vibesql_skip_tests {
    ...
    where-26.1 "String/integer type coercion in BETWEEN differs from SQLite"
    where-26.2 "String/integer type coercion in BETWEEN differs from SQLite"
    where-26.3 "String/integer type coercion differs from SQLite"
    where-26.4 "String/integer type coercion differs from SQLite"
    where-26.5 "String/integer type coercion in BETWEEN differs from SQLite"
    where-26.6 "String/integer type coercion in BETWEEN differs from SQLite"
    where-26.7 "String/integer type coercion differs from SQLite"
    where-26.8 "String/integer type coercion differs from SQLite"
    where-27.1 "Integer overflow behavior differs from SQLite"
    where-27.2 "Integer overflow behavior differs from SQLite"
    ...
    index-14.4 "Type affinity comparison with empty string differs from SQLite"
    index-14.5 "Type affinity comparison with empty string differs from SQLite"
    index-14.6 "Type affinity comparison with mixed types differs from SQLite"
    index-14.7 "Type affinity comparison with mixed types differs from SQLite"
    index-14.8 "Type affinity comparison with mixed types differs from SQLite"
    index-14.9 "Type affinity comparison with mixed types differs from SQLite"
    index-14.10 "Type affinity comparison with empty string differs from SQLite"
    ...
    where4-1.1b "Uses $null named placeholder - not supported"
    where4-1.2 "Cascades from where4-1.1b placeholder failure"
    where4-1.3 "Cascades from where4-1.1b placeholder failure"
    where4-1.4 "Cascades from where4-1.1b placeholder failure"
    where4-1.5 "Cascades from where4-1.1b placeholder failure"
    where4-1.6 "Cascades from where4-1.1b placeholder failure"
    where4-1.7 "Cascades from where4-1.1b placeholder failure"
    where4-1.8 "Cascades from where4-1.1b placeholder failure"
    where4-1.9 "Cascades from where4-1.1b placeholder failure"
    where4-1.10 "Cascades from where4-1.1b placeholder failure"
    where4-1.12 "Cascades from where4-1.1b placeholder failure"
    where4-1.15 "Cascades from where4-1.1b placeholder failure"
    where4-1.16 "Cascades from where4-1.1b placeholder failure"
    where4-3.1 "Cascades from where4-1.1b placeholder failure"
    where4-3.2 "Cascades from where4-1.1b placeholder failure"
    where4-3.3 "Cascades from where4-1.1b placeholder failure"
    where4-3.4 "Cascades from where4-1.1b placeholder failure"
    where4-5.1 "Cascades from where4-1.1b placeholder failure"
    where4-5.2 "Cascades from where4-1.1b placeholder failure"
    where4-5.3 "Cascades from where4-1.1b placeholder failure"
    ...
    altertab-14.1 "Uses generated columns"
    altertab-14.2 "Cascades from altertab-14.1"
    altertab-14.3 "Cascades from altertab-14.1"
    altertab-14.4 "Cascades from altertab-14.1"
    altertab-14.5 "Cascades from altertab-14.1"
    altertab-14.6 "Cascades from altertab-14.1"
    altertab-14.7 "Cascades from altertab-14.1"
    ...
    altertab-14.0 "Uses generated columns"
