...
bench-sysbench-srv-disc-mysql-title = MySQL-jämförelse
bench-sysbench-srv-disc-mysql = Serverbenchmarks jämför med MySQL för att utvärdera VibeSQL som ersättare för traditionella klient-server-databaser. VibeSQL Server överträffar MySQL på alla Sysbench-operationer, med hastighetsförbättringar från <strong>2,4x</strong> (intervallförfrågningar) till <strong>12,8x</strong> (indexerade uppdateringar).
bench-sysbench-srv-disc-perf-title = Varför VibeSQL Server är snabbare
bench-sysbench-srv-disc-perf-arch = VibeSQLs arkitektur skiljer sig fundamentalt från MySQLs traditionella RDBMS-design
bench-sysbench-srv-disc-perf-storage = VibeSQL använder en kolumnbaserad lagringsmotor i minnet optimerad för analytiska och OLTP-arbetsbelastningar, vilket undviker MySQLs diskbaserade InnoDB-sidhanteringsoverhead
bench-sysbench-srv-disc-perf-locking = Ingen tung radnivålåsning eller MVCC-bokföring—VibeSQL använder lättviktig samtidighetskontroll designad för moderna flerkärniga processorer
bench-sysbench-srv-disc-perf-protocol = Effektiv PostgreSQL wire protocol-implementering med minimal serialiseringsoverhead jämfört med MySQL-protokollet
bench-sysbench-srv-disc-perf-writes = Skrivoperationer (insättningar/uppdateringar) visar störst förbättring (<strong>8-12x</strong>) eftersom VibeSQL undviker MySQLs redo-logg, undo-logg och doublewrite buffer-synkronisering
bench-sysbench-srv-disc-perf-reads = Läsoperationer visar mindre men konsekvent förbättring (<strong>2-3x</strong>) tack vare cacheeffektiva kolumnåtkomstmönster och noll disk-I/O
