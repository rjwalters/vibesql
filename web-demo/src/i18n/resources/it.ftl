...
bench-sysbench-srv-disc-mysql-title = Confronto con MySQL
bench-sysbench-srv-disc-mysql = I benchmark server confrontano con MySQL per valutare VibeSQL come sostituto diretto per i database client-server tradizionali. VibeSQL Server supera MySQL in tutte le operazioni Sysbench, con accelerazioni da <strong>2,4x</strong> (query di intervallo) a <strong>12,8x</strong> (aggiornamenti indicizzati).
bench-sysbench-srv-disc-perf-title = Perché VibeSQL Server è più veloce
bench-sysbench-srv-disc-perf-arch = L'architettura di VibeSQL differisce fondamentalmente dal design RDBMS tradizionale di MySQL
bench-sysbench-srv-disc-perf-storage = VibeSQL usa un motore di archiviazione colonnare in memoria ottimizzato per carichi analitici e OLTP, evitando l'overhead della gestione pagine InnoDB basata su disco di MySQL
bench-sysbench-srv-disc-perf-locking = Nessun blocco pesante a livello di riga né contabilità MVCC—VibeSQL usa un controllo di concorrenza leggero progettato per CPU multi-core moderne
bench-sysbench-srv-disc-perf-protocol = Implementazione efficiente del protocollo PostgreSQL con overhead di serializzazione minimo rispetto al protocollo MySQL
bench-sysbench-srv-disc-perf-writes = Le operazioni di scrittura (inserimenti/aggiornamenti) mostrano i guadagni maggiori (<strong>8-12x</strong>) perché VibeSQL evita la sincronizzazione di redo log, undo log e doublewrite buffer di MySQL
bench-sysbench-srv-disc-perf-reads = Le operazioni di lettura mostrano guadagni minori ma costanti (<strong>2-3x</strong>) grazie a pattern di accesso colonnari efficienti in cache e zero I/O su disco
...
bench-bullet-concurrency = Concorrenza leggera
bench-bullet-protocol = Efficienza del protocollo
bench-bullet-writes = Operazioni di scrittura
bench-bullet-reads = Operazioni di lettura
...
# Sezione Suite di Test TCL SQLite
conformance-tcl-title = Suite di Test TCL SQLite
conformance-tcl-desc = Risultati della <a href="https://www.sqlite.org/testing.html" target="_blank" class="text-blue-600 dark:text-blue-400 hover:underline">suite di test TCL</a> canonica di SQLite contenente { $fileCount } file di test. Questa suite è lo standard di riferimento per i test di compatibilità SQLite.
conformance-tcl-overall-rate = Tasso di Superamento Generale
conformance-tcl-tests-passing = { $passed } di { $total } test superati
conformance-tcl-passed = Superati
conformance-tcl-failed = Falliti
conformance-tcl-skipped = Saltati
conformance-tcl-total = Totale
conformance-tcl-categories-title = Categorie di Test
conformance-tcl-category = Categoria
conformance-tcl-rate = Tasso
conformance-tcl-progress = Progresso
conformance-tcl-tests = Test
conformance-tcl-common-failures = Fallimenti Comuni
...
home-page-title = VibeSQL — Un Database SQL Puro Rust Progettato per la Velocità

# Sezione hero
home-hero-title = Un database SQL puro Rust<br>progettato per la velocità
home-hero-subtitle = VibeSQL scambia efficienza di archiviazione per prestazioni. Archiviazione ibrida righe + colonne, esecuzione vettorizzata e zero codice unsafe. Ottimizzato per dataset che entrano in memoria.
home-hero-subtext = Conforme a SQL:1999. Esegue nativamente, in WebAssembly e come libreria integrata.
home-btn-demo = Prova nel Browser
home-btn-github = GitHub
home-btn-crates = crates.io

# Sezione perché VibeSQL
home-why-title = Perché VibeSQL?
home-hybrid-title = Archiviazione Ibrida
home-hybrid-text = Archiviazione a righe e a colonne in un unico motore. Formato a righe per ricerche puntuali veloci e OLTP. Formato colonnare per scansioni analitiche con esecuzione vettorizzata. Nessuna necessità di scegliere.
home-speed-title = Velocità Prima dell'Archiviazione
home-speed-text = Scambia deliberatamente spazio su disco per prestazioni delle query. Layout di archiviazione ridondanti, caching aggressivo e indici precalcolati fanno sì che database più piccoli funzionino il più velocemente possibile.
home-rust-title = Rust Puro, Zero Unsafe
home-rust-text = Scritto interamente in Rust sicuro. Nessuna dipendenza da C, nessun FFI, nessun blocco unsafe. Si compila in binari nativi e WebAssembly dallo stesso codice sorgente.

# Sezione architettura
home-arch-title = Architettura
home-pipeline-title = Pipeline delle Query
home-pipeline-parser = <strong>Parser</strong> — Grammatica SQL:1999 completa, AST allocato in arena
home-pipeline-planner = <strong>Pianificatore</strong> — Ottimizzatore basato sui costi con riordinamento dei join
home-pipeline-executor = <strong>Esecutore</strong> — Esecuzione vettorizzata con elaborazione a lotti
home-pipeline-storage = <strong>Archiviazione</strong> — Ibrida righe/colonnare con indici B-tree
home-features-title = Funzionalità Principali
home-feature-window = Funzioni finestra (ROW_NUMBER, RANK, LEAD/LAG, NTILE, ...)
home-feature-cte = Espressioni di tabella comuni (WITH, CTE ricorsive)
home-feature-subquery = Subquery (correlate, EXISTS, IN, scalari)
home-feature-join = Supporto completo JOIN (INNER, LEFT, RIGHT, FULL, CROSS, NATURAL)
home-feature-triggers = Trigger, viste, chiavi esterne, vincoli CHECK
home-feature-wasm = Target WASM con archiviazione persistente OPFS

# Sezione prestazioni
home-perf-title = Prestazioni
home-perf-full = Benchmark completi →
home-stat-tpch-label = Query TPC-H Superate
home-stat-tpch-sub = Benchmark di supporto decisionale
home-stat-conformance-label = Tasso di Superamento SQLLogicTest
home-stat-conformance-sub = Oltre 6M di asserzioni di test
home-stat-tpcds-label = Query TPC-DS Superate
home-stat-tpcds-sub = Benchmark di analisi complessa
home-perf-note = Confrontato con SQLite, DuckDB e MySQL su carichi di lavoro equivalenti. <a href="benchmarks.html" class="text-blue-600 dark:text-blue-400 hover:underline">Vedi risultati completi.</a>

# Sezione inizia
home-start-title = Inizia
home-demo-title = Demo Interattiva
home-demo-text = Esegui query SQL nel tuo browser. Motore database completo compilato in WebAssembly con archiviazione persistente tramite OPFS. Nessuna installazione richiesta.
home-install-title = Installa
home-install-cargo = Cargo
home-install-library = Come libreria

# Sezione esplora
home-explore-conformance-title = Report di Conformità
home-explore-conformance-text = Analisi dettagliata della conformità agli standard SQL:1999 su 622 file di test.
home-explore-bench-title = Benchmark Prestazionali
home-explore-bench-text = Risultati TPC-H, TPC-DS, TPC-C e Sysbench contro SQLite, DuckDB e MySQL.

# Piè di pagina
home-footer = VibeSQL — Un database SQL puro Rust progettato per la velocità
