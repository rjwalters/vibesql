...
home-page-title = VibeSQL — SQL база данных на чистом Rust, созданная для скорости

# Hero section
home-hero-title = SQL база данных на чистом Rust,<br>созданная для скорости
home-hero-subtitle = VibeSQL жертвует эффективностью хранения ради производительности. Гибридное строковое и колоночное хранилище, векторизованное выполнение и ноль unsafe-кода. Оптимизировано для наборов данных, помещающихся в памяти.
home-hero-subtext = Соответствует SQL:1999. Работает нативно, в WebAssembly и как встраиваемая библиотека.
home-btn-demo = Попробовать в браузере
home-btn-github = GitHub
home-btn-crates = crates.io

# Why VibeSQL section
home-why-title = Почему VibeSQL?
home-hybrid-title = Гибридное хранилище
home-hybrid-text = Строковое и колоночное хранилище в одном движке. Строковый формат для быстрых точечных запросов и OLTP. Колоночный формат для аналитических сканирований с векторизованным выполнением. Не нужно выбирать.
home-speed-title = Скорость важнее объёма
home-speed-text = Осознанно жертвует дисковым пространством ради производительности запросов. Дублирующие схемы хранения, агрессивное кэширование и предвычисленные индексы позволяют небольшим базам данных работать максимально быстро.
home-rust-title = Чистый Rust, ноль unsafe
home-rust-text = Полностью написан на безопасном Rust. Без зависимостей от C, без FFI, без unsafe-блоков. Компилируется в нативные бинарники и WebAssembly из одной кодовой базы.

# Architecture section
home-arch-title = Архитектура
home-pipeline-title = Конвейер запросов
home-pipeline-parser = <strong>Парсер</strong> — Полная грамматика SQL:1999, AST с аренной аллокацией
home-pipeline-planner = <strong>Планировщик</strong> — Оптимизатор на основе стоимости с перестановкой JOIN
home-pipeline-executor = <strong>Исполнитель</strong> — Векторизованное выполнение с пакетной обработкой
home-pipeline-storage = <strong>Хранилище</strong> — Гибридное строковое/колоночное хранилище с B-tree индексами
home-features-title = Ключевые возможности
home-feature-window = Оконные функции (ROW_NUMBER, RANK, LEAD/LAG, NTILE, ...)
home-feature-cte = Обобщённые табличные выражения (WITH, рекурсивные CTE)
home-feature-subquery = Подзапросы (коррелированные, EXISTS, IN, скалярные)
home-feature-join = Полная поддержка JOIN (INNER, LEFT, RIGHT, FULL, CROSS, NATURAL)
home-feature-triggers = Триггеры, представления, внешние ключи, ограничения CHECK
home-feature-wasm = WASM-таргет с постоянным хранилищем OPFS

# Performance section
home-perf-title = Производительность
home-perf-full = Полные бенчмарки →
home-stat-tpch-label = TPC-H запросов пройдено
home-stat-tpch-sub = Бенчмарк поддержки принятия решений
home-stat-conformance-label = Процент прохождения SQLLogicTest
home-stat-conformance-sub = 6M+ тестовых утверждений
home-stat-tpcds-label = TPC-DS запросов пройдено
home-stat-tpcds-sub = Бенчмарк сложной аналитики
home-perf-note = Сравнение с SQLite, DuckDB и MySQL на эквивалентных нагрузках. <a href="benchmarks.html" class="text-blue-600 dark:text-blue-400 hover:underline">Полные результаты.</a>

# Get Started section
home-start-title = Начало работы
home-demo-title = Интерактивное демо
home-demo-text = Выполняйте SQL-запросы в браузере. Полный движок базы данных, скомпилированный в WebAssembly с постоянным хранилищем через OPFS. Установка не требуется.
home-install-title = Установка
home-install-cargo = Cargo
home-install-library = Как библиотека

# Explore section
home-explore-conformance-title = Отчёт о соответствии
home-explore-conformance-text = Подробная разбивка соответствия стандартам SQL:1999 по 622 тестовым файлам.
home-explore-bench-title = Бенчмарки производительности
home-explore-bench-text = Результаты TPC-H, TPC-DS, TPC-C и Sysbench в сравнении с SQLite, DuckDB и MySQL.

# Footer
home-footer = VibeSQL — SQL база данных на чистом Rust, созданная для скорости
