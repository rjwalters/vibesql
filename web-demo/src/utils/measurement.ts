...
export function formatMeasurement(
  ...
  const uncertaintyStr =
    roundedStddev !== undefined ? roundedStddev.toFixed(decimalPlaces) : undefined
 ...
 */
export function formatSpeedup(ratio: number, options: { precision?: number } = {}): string {
