...
fn test_scalar_subquery() {
    let subquery = SelectStmt {
        ...
        into_table: None,
        into_variables: None,
        from: Some(FromClause::Table { name: "employees".to_string(), alias: None, column_aliases: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
...
fn test_in_expression() {
    let subquery = SelectStmt {
        ...
        into_table: None,
        into_variables: None,
        from: Some(FromClause::Table { name: "departments".to_string(), alias: None, column_aliases: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
...
fn test_not_in_expression() {
    let subquery = SelectStmt {
        ...
        into_table: None,
        into_variables: None,
        from: Some(FromClause::Table { name: "excluded".to_string(), alias: None, column_aliases: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
