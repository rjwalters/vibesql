...
fn test_select_into_single_row() {
    ...
    let select_stmt = vibesql_ast::SelectStmt {
        ...
        into_variables: None,        from: Some(vibesql_ast::FromClause::Table { name: "source".to_string(), alias: None, column_aliases: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
    ...
    let query = vibesql_ast::SelectStmt {
        ...
        into_table: None,
        into_variables: None,        from: Some(vibesql_ast::FromClause::Table { name: "target".to_string(), alias: None, column_aliases: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
