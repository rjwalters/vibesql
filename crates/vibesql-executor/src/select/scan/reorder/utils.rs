...
pub(super) fn build_reordered_schema(
    ...
    CombinedSchema { table_schemas: new_table_schemas, total_columns: current_position, hidden_columns: std::collections::HashSet::new(), outer_schema: None, duplicate_aliases: std::collections::HashSet::new() }
}
