...
fn test_truncate_optimization_basic() {
    ...
    let stmt =
        DeleteStmt { quoted: false, only: false, table_name: "large_table".to_string(), where_clause: None };
...
fn test_truncate_blocked_by_fk_reference() {
    ...
    let stmt = DeleteStmt { quoted: false, only: false, table_name: "parent".to_string(), where_clause: None };
...
fn test_truncate_blocked_by_delete_trigger() {
    ...
    // separate)
    let stmt = DeleteStmt { quoted: false, only: false, table_name: "test_table".to_string(), where_clause: None };
