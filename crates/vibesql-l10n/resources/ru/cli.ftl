...
cannot-save-memory-database = Ошибка: Невозможно сохранить в '{ $path }' - это идентификатор базы данных в памяти, а не путь к файлу. Используйте вместо этого \save <имя_файла>.
