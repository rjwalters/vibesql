...
cannot-save-memory-database = Error: No se puede guardar en '{ $path }' - este es el identificador de la base de datos en memoria, no una ruta de archivo. Use \save <nombre_archivo> en su lugar.
