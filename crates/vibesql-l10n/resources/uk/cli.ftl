...
cannot-save-memory-database = Помилка: Неможливо зберегти до '{ $path }' - це ідентифікатор бази даних у пам'яті, а не шлях до файлу. Використовуйте натомість \save <ім'я_файлу>.
