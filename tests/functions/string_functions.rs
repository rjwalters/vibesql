...
fn test_upper_already_uppercase() {
    ...
    assert_eq!(results.len(), 1);
    assert_eq!(results[0].values[0], SqlValue::Varchar(StringValue::from("WORLD")));
}
...
fn test_upper_mixed_case() {
    ...
    assert_eq!(results.len(), 1);
    assert_eq!(results[0].values[0], SqlValue::Varchar(StringValue::from("HELLO WORLD")));
}
...
fn test_upper_with_numbers() {
    ...
    assert_eq!(results.len(), 1);
    assert_eq!(results[0].values[0], SqlValue::Varchar(StringValue::from("TEST123")));
}
...
fn test_upper_with_table_data() {
    ...
    db.insert_row("USERS", Row::new(vec![SqlValue::Varchar(StringValue::from("alice"))])).unwrap();
    db.insert_row("USERS", Row::new(vec![SqlValue::Varchar(StringValue::from("bob"))])).unwrap();
...
fn test_case_insensitive_function_names() {
    ...
    assert_eq!(results1[0].values[0], SqlValue::Varchar(StringValue::from("TEST")));
}
...
fn test_substring_single_char() {
    ...
    assert_eq!(results.len(), 1);
    assert_eq!(results[0].values[0], SqlValue::Varchar(StringValue::from("h")));
}
...
fn test_substring_length_exceeds_string() {
    ...
    assert_eq!(results.len(), 1);
    assert_eq!(results[0].values[0], SqlValue::Varchar(StringValue::from("llo")));
}
...
fn test_substring_start_exceeds_length() {
    ...
    assert_eq!(results.len(), 1);
    assert_eq!(results[0].values[0], SqlValue::Varchar(StringValue::from("")));
}
