...
fn test_count_star_in_multiplication() {
    ...
    let stmt = vibesql_ast::SelectStmt {
        ...
        from: Some(vibesql_ast::FromClause::Table { name: "tab2".to_string(), alias: None, column_aliases: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
...
fn test_count_star_with_unary_operators() {
    ...
    let stmt = vibesql_ast::SelectStmt {
        ...
        distinct: false,
        select_list: vec![vibesql_ast::SelectItem::Expression { expr: full_expr, alias: None }],
        from: Some(vibesql_ast::FromClause::Table { name: "tab1".to_string(), alias: None, column_aliases: None }),
        where_clause: None,
        group_by: None,
        having: None,
        order_by: None,
